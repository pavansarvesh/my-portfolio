...
export default async function PostLayout({ params }: Props) {
  ...
  return (
    <article className='prose prose-sm prose-neutral prose-headings:text-slate-200 mx-auto px-7 mt-10 text-yellow-500 prose-p:text-yellow-500 text-xs sm:p-0 sm:prose-code sm:text-lg flex flex-col flex-wrap'>
